...
describe("File Scanner", () => {
  test("should scan test workspace and find code files", async () => {
    const files = await scanFiles({ rootPath: TEST_WORKSPACE });
...
describe("Index Manager", () => {
  ...
  testFn("should index test workspace (requires API key)", async () => {
    ...
    const indexManager = new IndexManager(embeddingService, vectorStore, TEST_STORAGE, TEST_WORKSPACE);
