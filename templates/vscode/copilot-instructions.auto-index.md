...
This project uses [Memory Bank MCP](https://github.com/grec0/memory-bank-mcp) with **automatic indexing**. You MUST keep the Memory Bank synchronized with all code changes.
